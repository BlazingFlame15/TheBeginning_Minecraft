...
public class ConvertismBlock extends BeginningModElements.ModElement {
	@ObjectHolder("beginning:convertism")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("beginning:convertism_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public ConvertismBlock(BeginningModElements instance) {
		super(instance, 54);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("beginning:blocks/convertism_actuallystill"), new ResourceLocation("beginning:blocks/convertism_still"))
				.luminosity(0).density(1).viscosity(1).gaseous()).bucket(() -> bucket).block(() -> block);
