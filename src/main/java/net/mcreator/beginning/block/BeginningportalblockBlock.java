...
public class BeginningportalblockBlock extends BeginningModElements.ModElement {
	@ObjectHolder("beginning:beginningportalblock")
	public static final Block block = null;
	public BeginningportalblockBlock(BeginningModElements instance) {
		super(instance, 4);
	}
