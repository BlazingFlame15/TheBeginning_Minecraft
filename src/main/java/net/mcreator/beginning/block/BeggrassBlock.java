...
public class BeggrassBlock extends BeginningModElements.ModElement {
	@ObjectHolder("beginning:beggrass")
	public static final Block block = null;
	public BeggrassBlock(BeginningModElements instance) {
		super(instance, 9);
	}
