...
public class BeginningsaplingBlock extends BeginningModElements.ModElement {
	@ObjectHolder("beginning:beginningsapling")
	public static final Block block = null;
	public BeginningsaplingBlock(BeginningModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.PLANT).hardnessAndResistance(1f, 10f).lightValue(0).doesNotBlockMovement()
					.notSolid());
