...
public class BeginningPlankBlock extends BeginningModElements.ModElement {
	@ObjectHolder("beginning:beginning_plank")
	public static final Block block = null;
	public BeginningPlankBlock(BeginningModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("beginning_plank");
		}
