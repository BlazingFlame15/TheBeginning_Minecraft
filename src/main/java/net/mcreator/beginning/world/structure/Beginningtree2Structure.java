...
public class Beginningtree2Structure extends BeginningModElements.ModElement {
	public Beginningtree2Structure(BeginningModElements instance) {
		super(instance, 31);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("beginning", "beginning_tree_2_small"));
						if (template == null)
							return false;
