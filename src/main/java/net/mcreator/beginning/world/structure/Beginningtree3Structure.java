...
public class Beginningtree3Structure extends BeginningModElements.ModElement {
	public Beginningtree3Structure(BeginningModElements instance) {
		super(instance, 32);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("beginning", "beginning_tree_3_tall"));
						if (template == null)
							return false;
