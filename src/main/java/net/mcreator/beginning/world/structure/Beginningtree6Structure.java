...
package net.mcreator.beginning.world.structure;
...
public class Beginningtree6Structure extends BeginningModElements.ModElement {
	public Beginningtree6Structure(BeginningModElements instance) {
		super(instance, 35);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("beginning", "beginning_tree_6_2x2_version_3"));
						if (template == null)
							return false;
