...
public class Beginningtree1Structure extends BeginningModElements.ModElement {
	public Beginningtree1Structure(BeginningModElements instance) {
		super(instance, 30);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("beginning", "beginning_tree_1_big"));
						if (template == null)
							return false;
